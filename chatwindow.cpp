...

{
    ...
    connect(ui->startStopButton, &QPushButton::clicked, this, &ChatWindow::toggleStartServer);
    connect(m_chatServer, &ChatServer::logMessage, this, &ChatWindow::logMessage);
}
...
void ChatWindow::logMessage(const QString &msg)
{
